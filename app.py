...
if st.button("🔍 Enhanced Search", key="search_btn", type="primary") and query.strip():
...
pip install streamlit sentence-transformers pandas numpy scikit-learn rank-bm25 fuzzywuzzy python-levenshtein faker
